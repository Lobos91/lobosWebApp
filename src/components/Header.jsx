...
const Header = () => {
  ...
  return (
    <div>
      <nav class="flex fixed top-0 left-0 right-0 items-center justify-between flex-wrap bg-amber-500 hover:bg-red-600 hover:font-bold transition-colors duration-500 p-4 ">
        ...
        <div id="nav-menu" class="w-full block flex-grow lg:flex lg:w-auto  ">
          <div class="text-base lg:flex-grow mt-4">
            ...
            <a
              ...
              class="text-center inline-flex flex-wrap items-centerlg:mt-0 text-slate-900 hover:text-white mr-4"
            >
              <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"  class="w-6 h-6 mr-0.5">
